...
function App() {
  ...
  const [paginabase] = useState('http://miguelaoz.atwebpages.com/Innmoviliaria/PHP_BLOCK/Process/'); //http://localhost:255/innmoviliaria/Process/
  ...
  return (
    <div className="App">
      ...
      <HEADER paginabase = {paginabase} navpages = {navpages} paginaactual = {paginaactual} setpaginaactial = {setpaginaactial}/>
